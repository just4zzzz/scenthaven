...
<head>
    ...
    <title>Sign Up - Scent Haven</title>
...
<body>
    <div class="wrapper">
        ...
        <p class="welcome-text">Join our fragrance community today</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                <label>Username</label>
                <div class="input-group">
                    <input type="text" name="username" class="form-control" value="<?php echo $username; ?>" placeholder="Choose a username">
